...
public final class NormalAboutItem extends AboutItem {

    private NormalAboutItem(NormalAboutItem.Builder builder) {
    ...
    public static class Builder {
        ...
        public NormalAboutItem build() {
            return new NormalAboutItem(this);
        }
